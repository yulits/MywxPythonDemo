...
class TextFrame(wx.Frame):
    def __init__(self):
        ...
        multiText = wx.TextCtrl(panel, -1,                                         # Создание текстового поля
        ...
        multiText.SetInsertionPoint(0)                                             # Установка позиции курсора
        richLabel = wx.StaticText(panel, -1, "Rich Text")                          # Создание расширенного текста
        ...
        richText.SetStyle(44, 52, wx.TextAttr("white", "black"))                    # Установка текстовых стилей
        points = richText.GetFont().GetPointSize()
        f = wx.Font(points + 3, wx.ROMAN,
            wx.ITALIC, wx.BOLD, True)                                               #  Создание шрифта
        richText.SetStyle(68, 82, wx.TextAttr("blue",        
            wx.NullColour, f))                                                      # Установка стиля нового шрифта
